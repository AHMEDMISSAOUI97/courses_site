                ...
                <div class=" offset-md-1">
                    <div class="card">
                        <div class="card-header" style="background-color:#fff;">
                            <h2 style="color:black">{!! $course->name !!}</h2>
                        </div>
                        <div class="card-body">
                            ...
                            {!! $course->for_whom !!}
                            <p>
                            <h3 id="programme" style="color:black">Programme :</h3>
                            </p>
                            <div class="divider_line" style="width:30%;">
                            </div>
                            <br>
                            {!! $course->program !!}
                            <p>
                            <h3 id="objectifs" style="color:black">Objectif :</h3>
                            </p>
                            <div class="divider_line" style="width:30%;">
                            </div><br>
                            {!! $course->objectif !!}
                            <p>
                            <h3 id="certificat" style="color:black">Certification :</h3>
                            </p>
                            <div class="divider_line" style="width:30%;">
                            </div><br>
                            {!! $course->certificate !!}
                            <p>
                            <h3 id="points-forts" style="color:black">Points forts :</h3>
                            </p>
                            <div class="divider_line" style="width:30%;">
                            </div><br>
                            {!! $course->key_strengths !!}
                            <p>
                            <h3 id="financement" style="color:black">Financement :</h3>
                            </p>
                            <div class="divider_line" style="width:30%;">
                            </div>
                            <br>
                            {!! $course->financement !!}
                            <p>
                            <h3 id="prerequis" style="color:black">Pré requis :</h3>
                            <div class="divider_line" style="width:30%;">
                            </div>
        ...
        <div class="content-container" style="text-align: center;height: fit-content">
            ...
            <div id="remvoepadding" class="price-section">
                ...
                <div class="feature-box" style="display: flex; justify-content: center; align-items: center;">
                    <div class="box-right" style="text-align: left;">
                        <div class="content-title">
                            <li style="display:flex">- Formation E-learning</li>
                        </div><br>
                        <div class="content-title">
                            <li style="display:flex">- Durée : {!! $course->duration !!} </li>
                        </div><br>
                        <div class="content-title">
                            <li style="display:flex">- Prix : {!! $course->price !!} €</li>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="price-button">
                    <a class="kc_button button-box" href="#" target="_self">
                        S'inscrire
                    </a>
                </div>
            </div>
