                ...
                <div class="content-wrapper">
                    ...
                    <div class="div_center">
                        ...
                        <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                            ...
                            <div>
                                <input class="input_color" type="text" name="name"
                                    placeholder=" Ecrire le nom du catégorie">
                            </div>
                            <br>
                            <div>
                    ...
                    <table class="table table-bordered" style="color: white">
                        <tr>
                            ...
                            <td style="text-align: center">image du catégorie</td>
                            <td style="text-align: center">Action</td>
                        </tr>
                        @foreach ($categories as $categorie)
                            <tr>
                                <td style="text-align: center">{{ $categorie->name }}</td>
                                <td style="text-align: center"><img style="height: 150px ; width:150px" src="{{ asset('storage/' . $categorie->image) }}" alt=""></td>
                                <td style="text-align: center">
                                    ...
                                    <a class="btn btn-success"
                                        href="{{ route('categories.edit', $categorie->id) }}">Modifier</a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
