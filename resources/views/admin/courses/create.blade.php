            ...
            <div class="content-wrapper">
                <div class="content-wrapper">
                    ...
                    <div class="div_center">
                        <h2 class="h2_font">Ajouter une Formation</h2>
                        <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="input_course">
                                <label for="program">Programme du Formation : </label>
                            ...
                            <div class="input_course">
                                <label for="certificate">Certification du Formation:</label>
                                <input id="certificate" type="hidden" name="certificate">
                                <trix-editor input="certificate"></trix-editor>
                            </div>
                            <div class="input_course">
                                <label for="key_strengths">Point forts du Formation : </label>
                    ...
                    <table class="table table-bordered" style="color: white">
                        <tr>
                            ...
                            <td style="text-align: center">Image du formation</td>
                            <td style="text-align: center">Catégorie du formation</td>
                            <td style="text-align: center">Action</td>
                        </tr>
                        @foreach ($courses as $course)
                            <tr>
                                <td style="text-align: center">{!! $course->name !!}</td>
                                <td style="text-align: center"><img style="height: 150px ; width:150px" src="{{ asset('storage/' . $course->image) }}" alt=""></td>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <a class="btn btn-success"
                                        href="{{ route('courses.edit', $course->id) }}">Modifier</a>
                                </td>
